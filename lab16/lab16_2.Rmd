...
```{}
mv genome01_blastn_csv BIS15LW2026_avongsavanh/lab16/data/blast_results/
ls BIS15LW2026_avongsavanh/lab16/data/blast_results/
```
...
```{r}
genome01_blastn <- read_csv("data/blast_results/genome01_blastn.csv") %>% 
  clean_names()
```
...
```{r}
genome01_blastn %>% 
  select(description, e_value, accession) %>% 
...
```{r}
read_csv("data/blast_results/blastp_results.csv")
```
